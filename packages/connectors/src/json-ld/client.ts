...
// oxlint-disable-next-line anti-slop/no-unknown-parameters, anti-slop/no-unsafe-dictionary-type, anti-slop/no-runtime-typeof -- JSON.parse returns unknown; this narrows the JSON listing traversal boundary.
...
export const extractJsonListingUrls = (
  ...
  const urls: JsonLdDiscoveryUrl[] = [];
  for (const value of values) {
    // oxlint-disable-next-line anti-slop/no-runtime-typeof -- JSON listing leaves are untyped external values.
