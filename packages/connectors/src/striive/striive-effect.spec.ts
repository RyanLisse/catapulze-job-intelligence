...
import { createStriiveEffectClient } from "./client-effect";
...
describe("striive Effect read adapter", () => {
  it("fixture listing matches native Promise contract", async () => {
    const client = createStriiveEffectClient({ liveEnabled: false });
  ...
  it("maps 401 through shared runtime", async () => {
    const client = createStriiveEffectClient({
