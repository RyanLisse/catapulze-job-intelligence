...
Status: **DEC-005 gekozen, productie-readiness nog te bewijzen**
Doel: Catapulze gebruikt vanaf P0 een nieuwe PostgreSQL 16-database in Docker. De bestaande Motian-Neon-database is uitsluitend een read-only importbron.
