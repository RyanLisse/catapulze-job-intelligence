...
| `jobType` | `bron_specifiek.contract_type` | CTP-524, F06: whitelisted 2026-09-15; `null` in alle 25 records van de live capture. Zie "CTP-524 vervolgonderzoek" hieronder. |
| `tags` (`tagNames` blijft ongebruikt) | `bron_specifiek.skills` | CTP-524, F15: whitelisted 2026-09-15 via `normaliseSkills`; `[]` in alle 25 records van de live capture, entry-vorm nooit gezien. Zie "CTP-524 vervolgonderzoek" hieronder. |
